$(function () {
    ...
    $X_Table.XGrid({
        ...
        colNames: ['序号', '单据编号', '单据类型', '单据状态', '是否监管', '采购订单编号', '行号', '商品编号', '商品规格', '生产厂家',
            '包装单位', '收货数', '是否特殊药品', '批号', '生产日期', '有效期至', '容器编号', '单价', '总金额', '中包装规格',
            '件包装规格', '收货零散数', '收货件数', '收货结论', '处理原因', '在途数量', '预计到货日期', '拒收备注', '单据创建时间',
            '单据完成时间', '单据操作'
        ],
        colModel: [{
            name: 'id',
