$(function () {
    ...
    $X_Tableb.XGrid({
        ...
        colNames: ['序号', '购进退出复核单编号', '供应商编号', '供应商名称', '退货单编号', '日期', '采购员', '退货类别', '是否中药',
    ...
    $X_Table.XGrid({
        ...
        colNames: ['行号', '商品大类', '商品编号', '商品名称', '商品规格', '是否中药', '生产厂家', '包装单位', '供应商编号', '供应商名称',
            '购进退出单行号', '申请退货数', '退货件数', '退货零散数', '退货总数', '容器编号', '大包装规格', '库别', '显示货位', '产地',
            '批号', '生产日期', '有效期至', '剂型', '金额', '库存状态', '批准文号', '复核退货件数', '复核退货零散数', '复核退货数',
            '复核退货数变更'
        ],
        colModel: [{
            name: 'id',
